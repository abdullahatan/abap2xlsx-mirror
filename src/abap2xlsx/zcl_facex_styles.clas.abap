CLASS zcl_facex_styles DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    METHODS register_new_style
      IMPORTING
        !io_style            TYPE REF TO zcl_facex_style
      RETURNING
...
*"* do not include other source files here!!!
  ...
  PRIVATE SECTION.
    ...
    DATA styles TYPE REF TO zcl_facex_collection .
ENDCLASS.



CLASS zcl_facex_styles IMPLEMENTATION.
