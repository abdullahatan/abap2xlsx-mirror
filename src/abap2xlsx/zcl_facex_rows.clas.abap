...
*
*----------------------------------------------------------------------*
CLASS zcl_facex_rows DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    METHODS add
      IMPORTING
        !io_row TYPE REF TO zcl_facex_row .
    METHODS clear .
    METHODS constructor .
    METHODS get
      IMPORTING
...
CLASS zcl_facex_rows IMPLEMENTATION.
