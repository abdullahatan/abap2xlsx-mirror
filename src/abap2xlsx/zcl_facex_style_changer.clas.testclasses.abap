CLASS ltcl_test DEFINITION FOR TESTING DURATION SHORT RISK LEVEL HARMLESS FINAL.
  ...
  PRIVATE SECTION.
    DATA mi_cut       TYPE REF TO zif_facex_style_changer.
    DATA mo_excel     TYPE REF TO zcl_facex.
    DATA mo_worksheet TYPE REF TO zcl_facex_worksheet.
...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD setup.
    ...
    mi_cut = zcl_facex_style_changer=>create( mo_excel ).
  ENDMETHOD.

  METHOD apply.

    DATA lv_guid TYPE zfacex_cell_style.
