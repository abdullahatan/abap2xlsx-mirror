CLASS zcl_facex_security DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    DATA revisionspassword TYPE zfacex_revisionspassword .
    DATA workbookpassword TYPE zfacex_workbookpassword .
...
CLASS zcl_facex_security IMPLEMENTATION.
