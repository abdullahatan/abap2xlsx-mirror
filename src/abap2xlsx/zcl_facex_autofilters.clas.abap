CLASS zcl_facex_autofilters DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF ts_autofilter,
        ...
        autofilter TYPE REF TO zcl_facex_autofilter,
...
CLASS zcl_facex_autofilters IMPLEMENTATION.
  ...
  METHOD add.
    ...
    IF sy-subrc = 0.
      RAISE EXCEPTION TYPE zcx_facex. " adding another autofilter to sheet is not allowed
    ENDIF.
