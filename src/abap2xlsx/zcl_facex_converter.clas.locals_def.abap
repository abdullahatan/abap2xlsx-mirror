...
TYPES: BEGIN OF ts_subtotal_rows,
         row_int       TYPE zfacex_cell_row,
         row_int_start TYPE zfacex_cell_row,
...
TYPES: BEGIN OF ts_styles,
         ...
         alignment TYPE zfacex_alignment,
...
TYPES: BEGIN OF ts_color_styles,
         guid_old  TYPE zfacex_cell_style,
         fontcolor TYPE zfacex_style_color_argb,
         fillcolor TYPE zfacex_style_color_argb,
         style_new TYPE REF TO zcl_facex_style,
