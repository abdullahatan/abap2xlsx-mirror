CLASS zcl_facex_template_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: tt_sheet_titles TYPE STANDARD TABLE OF zfacex_sheet_title WITH DEFAULT KEY,
...
CLASS zcl_facex_template_data IMPLEMENTATION.
