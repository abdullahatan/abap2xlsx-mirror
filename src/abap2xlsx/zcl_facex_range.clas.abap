CLASS zcl_facex_range DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    DATA name TYPE zfacex_range_name .
    DATA guid TYPE zfacex_range_guid .

    METHODS get_guid
      RETURNING
        VALUE(ep_guid) TYPE zfacex_range_guid .
    METHODS set_value
      IMPORTING
    ...
    METHODS get_value
      RETURNING
        VALUE(ep_value) TYPE zfacex_range_value .
    METHODS set_range_value
      IMPORTING
        !ip_value TYPE zfacex_range_value .
...
*"* do not include other source files here!!!
  PRIVATE SECTION.
    ...
    DATA value TYPE zfacex_range_value .
ENDCLASS.



CLASS zcl_facex_range IMPLEMENTATION.
  ...
  METHOD set_value.
    ...
    me->value = zcl_facex_common=>escape_string( ip_value = lv_value ).
