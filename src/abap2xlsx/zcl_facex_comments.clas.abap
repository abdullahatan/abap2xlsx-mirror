CLASS zcl_facex_comments DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        !io_from TYPE REF TO zcl_facex_comments OPTIONAL .
    METHODS get
      IMPORTING
        !ip_index         TYPE zfacex_active_worksheet
      RETURNING
  ...
  PRIVATE SECTION.
    ...
    DATA comments TYPE REF TO zcl_facex_collection .
ENDCLASS.



CLASS zcl_facex_comments IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    DATA: lo_comment  TYPE REF TO zcl_facex_comment,
