CLASS zcl_facex_font DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS lc_default_font_name TYPE zfacex_style_font_name VALUE 'Calibri' ##NO_TEXT.

    CLASS-METHODS calculate_text_width
      IMPORTING
        !iv_font_name   TYPE zfacex_style_font_name
        !iv_font_height TYPE ty_font_height
        !iv_flag_bold   TYPE abap_bool
        !iv_flag_italic TYPE abap_bool
        !iv_cell_value  TYPE zfacex_cell_value
      RETURNING
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF mty_s_font_cache,
        font_name       TYPE zfacex_style_font_name,
...
CLASS zcl_facex_font IMPLEMENTATION.
